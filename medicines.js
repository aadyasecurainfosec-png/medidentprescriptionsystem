...
function initMedicineAutocomplete() {
  if (document.getElementById("medDatalist")) return;
...
// Build a quick lookup by lowercase name for auto-filling composition
const MEDICINE_LOOKUP = MEDICINE_DB.reduce((map, m) => {
